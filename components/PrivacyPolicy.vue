<template>
  ...
  >
    <v-card-text>
      <h3>プライバシーポリシー</h3>
      <p>
        松井英俊（以下，「当方」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
      </p>
      ...
      <p>本ポリシーに関するお問い合わせは，本ページ上部のContactフォームよりお願いいたします。</p>
    </v-card-text>
  </v-card>
</template>
